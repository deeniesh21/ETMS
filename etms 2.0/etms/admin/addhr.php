...
$sql="INSERT INTO tblhumanresources(HrId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status)";
...
if($lastInsertId)
{
$msg="Human Resources Manager record added Successfully";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Add Human Resources Manager</title>
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add Human Resources Manager</div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="addemp">
                                    <div>
                                        <h3>Human Resources Manager Info</h3>
                                        <section>
