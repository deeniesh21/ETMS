...
$sql="INSERT INTO tblcashmanager(CmId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status)";
...
if($lastInsertId)
{
$msg="Cash Manager record added Successfully";
}
else 
{
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Add Cash Manager</title>
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add cash manager</div>
                    </div>
