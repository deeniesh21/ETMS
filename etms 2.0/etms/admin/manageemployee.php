...
if($stats){
 ...
 {?>
<a href="manageemployee.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete this Employe?');"" > <i class="material-icons" title="Delete">delete_forever</i>
<?php } else {?>
