...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Training | Payment History</title>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="120">Amount RM</th>
                                            <th>From</th>
                                            <th>To</th>
                                             <th width="120">Posting Date</th>
                                            <th width="200">Cash Manager Remark</th>
                                            <th>Status</th>
                                        </tr>
                                    </thead>
...
<?php 
$eid=$_SESSION['eid'];
$sql = "SELECT PaymentType,Amount,ToDate,FromDate,PostingDate,AdminRemarkDate,AdminRemark,Status from tblpayment where empid=:eid";
