...
$username=$_SESSION['emplogin'];
    $sql ="SELECT Password FROM tblhumanresources WHERE EmailId=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblhumanresources set Password=:newpassword where EmailId=:username";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Human Resources Manager | Change Password</title>
