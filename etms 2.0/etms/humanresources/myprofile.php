...
$sql="update tblhumanresources set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where HrId=:eid";
...
<?php 
$eid=$_SESSION['emplogin'];
$sql = "SELECT * from  tblhumanresources where HrId=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
