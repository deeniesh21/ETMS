...
$sql="INSERT INTO tblpayment(paymenttype,ToDate,FromDate,Description,Status,Amount,IsRead,empid) VALUES(:paymenttype,:todate,:fromdate,:description,:status,:amount,:isread,:empid)";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Cash Manager | Add Payment</title>
...
<select  name="paymenttype" autocomplete="off">
<option value="">Select training type...</option>
<?php $sql = "SELECT  paymenttype from tblpaymenttype";
$query = $dbh -> prepare($sql);
$query->execute();
...
<input id="paymenttype" name="paymenttype" value="<?php echo htmlentities($result->PaymentType);?>" type="text" autocomplete="off" required>
</div>
...
<input id="amount" name="amount" value="<?php echo htmlentities($result->Amount);?>" type="text" autocomplete="off" required>
</div>
