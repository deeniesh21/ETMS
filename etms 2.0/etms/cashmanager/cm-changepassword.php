...
$username=$_SESSION['emplogin'];
    $sql ="SELECT Password FROM tblcashmanager WHERE EmailId=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblcashmanager set Password=:newpassword where EmailId=:username";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Cash Manager | Change Password</title>
