...
$con="update tbltrainer set Password=:newpassword where id=:empid";
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Trainer Password Recovery</h4></div>

                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">

                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;">Trainer details</span>
...
$empid=$_POST['empid'];
$email=$_POST['emailid'];
$sql ="SELECT id FROM tbltrainer WHERE EmailId=:email and TrId=:empid";
