...
$sql="update tblcashmanager set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where CmId=:eid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Cash Manager | Update Cash Manager</title>
...
<?php 
$eid=$_SESSION['emplogin'];
$sql = "SELECT * from  tblcashmanager where CmId=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
...
<label for="empcode">Cash Manager Code</label>
