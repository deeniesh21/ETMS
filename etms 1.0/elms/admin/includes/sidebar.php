     <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="addleavetype.php">Add Training Type</a></li>
                                <li><a href="manageleavetype.php">Manage Training Type</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
   ...
   <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">desktop_windows</i>Training Management<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="leaves.php">All Training </a></li>
                                <li><a href="pending-leavehistory.php">Pending Leaves </a></li>
                                <li><a href="approvedleave-history.php">Approved Training</a></li>
                                  <li><a href="notapproved-leaves.php">Not Approved Training</a></li>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="changepassword.php"><i class="material-icons">settings_input_svideo</i>Chnage Password</a></li>
                   ...
                   <div class="footer">
                    <p class="copyright"><a href="http://phpgurukul.com/">ETMS </a>©</p>
